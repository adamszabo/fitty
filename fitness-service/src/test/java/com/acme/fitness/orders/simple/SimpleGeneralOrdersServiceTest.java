...
public class SimpleGeneralOrdersServiceTest {
	...
	public void testNewBasketShouldReturnProperly() {
		...
		BDDMockito.given(basketServiceMock.newBasket(client)).willReturn(expected);
	...
	public void testAddMembershipToBasketShouldInvokeTheMethodRight() {
		...
		// THEN
		BDDMockito.verify(basketServiceMock).addMembershipToBasket(basket, membership);
	...
	public void testAddTrainingToBasketShouldInvokeTheMethodRight() {
		...
		// THEN
		BDDMockito.verify(basketServiceMock).addTrainingToBasket(basket, training);
	}
	...
	public void testAddOrderItemToBasketShouldInvokeTheMethodRight() {
		...
		// THEN
		BDDMockito.verify(basketServiceMock).addOrderItemToBasket(basket, orderItem);
	}
	...
	public void testGetMembershipsShouldReturnProperly() {
		...
		BDDMockito.given(basketServiceMock.getMemberships(basket)).willReturn(expected);
		underTest.setBasketService(basketServiceMock);
		//WHEN
	...
	public void testGetTrainingsShouldReturnProperly() {
		...
		BDDMockito.given(basketServiceMock.getTrainings(basket)).willReturn(expected);
		underTest.setBasketService(basketServiceMock);
		//WHEN
	...
	public void testGetOrderItemsShouldReturnProperly() {
		...
		BDDMockito.given(basketServiceMock.getOrderItems(basket)).willReturn(expected);
		underTest.setBasketService(basketServiceMock);
		//WHEN
	...
	public void testGetBasketsByUserShouldReturnProperly() {
		...
		BDDMockito.given(basketServiceMock.getBasketsByUser(user)).willReturn(expected);
		underTest.setBasketService(basketServiceMock);
		//WHEN
	...
	public void testGetBasketByIdShouldReturnProperly() throws FitnessDaoException {
		//GIVEN
		Basket expected = new Basket();
		BDDMockito.given(basketServiceMock.getBasketById(Mockito.anyLong())).willReturn(expected);
		underTest.setBasketService(basketServiceMock);
		//WHEN
	...
	public void testGetBasketByIdShouldThrowException() throws FitnessDaoException {
		//GIVEN
		BDDMockito.given(basketServiceMock.getBasketById(Mockito.anyLong())).willThrow(new FitnessDaoException());
		underTest.setBasketService(basketServiceMock);
		//WHEN
	...
	public void testNewOrderItemShouldReturnProperly() {
		...
		BDDMockito.given(orderItemServiceMock.newOrderItem(product, quantity)).willReturn(expected);
	...
	@Test
	public void testGetOrderItemByIdShouldReturnProperly() throws FitnessDaoException {
		//GIVEN
		OrderItem expected = new OrderItem();
		BDDMockito.given(orderItemServiceMock.getOrderItemById(Mockito.anyLong())).willReturn(expected);
		underTest.setOrderItemService(orderItemServiceMock);
		//WHEN
		OrderItem result = underTest.getOrderItemById(1L);
		//THEN
		BDDMockito.verify(orderItemServiceMock).getOrderItemById(Mockito.anyLong());
		Assert.assertEquals(expected, result);
	}
	
	@Test(expected = FitnessDaoException.class)
	public void testGetOrderItemByIdShouldThrowException() throws FitnessDaoException {
		//GIVEN
		BDDMockito.given(orderItemServiceMock.getOrderItemById(Mockito.anyLong())).willThrow(new FitnessDaoException());
		underTest.setOrderItemService(orderItemServiceMock);
		//WHEN
	...
	public void testAddProductToStoreShouldReturnProperly() {
		...
		BDDMockito.given(storeServiceMock.addProduct(product, quantity)).willReturn(expected);
	...
	@Test
	public void testGetStoreByProductShouldReturnProperly() throws FitnessDaoException {
		//GIVEN
		Product product = new Product();
		Store expected = new Store();
		BDDMockito.given(storeServiceMock.getStoreByProduct(product)).willReturn(expected);
		underTest.setStoreService(storeServiceMock);
		//WHEN
	...
	@Test(expected = FitnessDaoException.class)
	public void testGetStoreByProductShouldThrowException() throws FitnessDaoException {
		//GIVEN
		Product product = new Product();
		BDDMockito.given(storeServiceMock.getStoreByProduct(product)).willThrow(new FitnessDaoException());
		underTest.setStoreService(storeServiceMock);
		//WHEN
	...
	@Test
	public void testTakeOutProductShouldReturnProperly() throws FitnessDaoException {
		//GIVEN
		Product product = new Product();
		int quantity = 1;
		boolean expected = true;
		BDDMockito.given(storeServiceMock.takeOutProduct(product, quantity)).willReturn(expected);
		underTest.setStoreService(storeServiceMock);
		//WHEN
	...
	@Test(expected = FitnessDaoException.class)
	public void testTakeOutProductShouldThrowException() throws FitnessDaoException {
		//GIVEN
		Product product = new Product();
		int quantity = 1;
		BDDMockito.given(storeServiceMock.takeOutProduct(product, quantity)).willThrow(new FitnessDaoException());
		underTest.setStoreService(storeServiceMock);
		//WHEN
	...
	@Test
	public void testPutInProductShouldReturnProperly() throws FitnessDaoException {
		//GIVEN
		Product product = new Product();
		int quantity = 1;
		boolean expected = true;
	...
	@Test(expected = FitnessDaoException.class)
	public void testPutInProductShouldThrowException() throws FitnessDaoException {
		//GIVEN
		Product product = new Product();
		int quantity = 1;
		BDDMockito.doThrow(new FitnessDaoException()).when(storeServiceMock).putInProduct(product, quantity);
		underTest.setStoreService(storeServiceMock);
		//WHEN
